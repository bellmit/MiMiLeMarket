...
public class ProductAdapter extends CommonAdapter<Product> {
    ...
    public ProductAdapter(Context context, List<Product> data, int layoutId) {
    ...
    public void setConverView(final CommonViewHolder myViewHolder, Product product) {
        ...
        product.getImage().download(new DownloadFileListener() {
            ...
            public void done(String s, BmobException e) {
                if (e == null) {
                    ((ImageView) myViewHolder.getView(R.id.product_browse_item_image)).setImageBitmap(ImageUtil.getLoacalBitmap(s));
                }
            }
        ...
        ((TextView) myViewHolder.getView(R.id.product_browse_item_name)).setText(product.getDetail());

        ((TextView) myViewHolder.getView(R.id.product_browse_item_salNum)).setText(String.valueOf(product.getSalNum()));

        ((TextView) myViewHolder.getView(R.id.product_browse_item_price)).setText("￥" + product.getPrice());
    }
}
